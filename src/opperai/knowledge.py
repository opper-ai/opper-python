...
class Knowledge(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(
                models.CreateKnowledgeBaseResponse, http_res
            )
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(
                models.GetKnowledgeBaseResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    def get_upload_url(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.GetUploadURLResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
    ...
    def register_file_upload(
        ...
        *,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json_response(
                models.RegisterFileUploadResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json_response(
                errors.BadRequestErrorData, http_res
