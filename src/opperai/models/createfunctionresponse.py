...
class CreateFunctionResponseTypedDict(TypedDict):
    name: str
    ...
    configuration: NotRequired[Nullable[FunctionCallConfigurationOutputTypedDict]]
    ...
    r"""The ID of the dataset associated with the function"""
    revision_id: NotRequired[Nullable[str]]
    r"""The ID of the latest revision of the function"""
    observer_enabled: NotRequired[bool]
    r"""Whether the observer is enabled for this function. When enabled, the observer monitors and evaluates all generations."""
...
class CreateFunctionResponse(BaseModel):
    ...
    configuration: OptionalNullable[FunctionCallConfigurationOutput] = UNSET
    r"""Optional configuration for the function.Configuration is a dictionary of key-value pairs that can be used to override the default configuration for the function."""

    dataset_id: OptionalNullable[str] = UNSET
    r"""The ID of the dataset associated with the function"""

    revision_id: OptionalNullable[str] = UNSET
    r"""The ID of the latest revision of the function"""

    observer_enabled: Optional[bool] = True
    r"""Whether the observer is enabled for this function. When enabled, the observer monitors and evaluates all generations."""
