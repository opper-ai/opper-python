...
from opperai.types import BaseModel, OptionalNullable, UNSET
from opperai.utils import get_security_from_env
from typing import Any, Mapping, Optional, Union, cast


class Openai(BaseSDK):
    def create_chat_completion(
        self,
        *,
        request: Union[models.Payload, models.PayloadTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.Payload)
        request = cast(models.Payload, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="chat_completions_openai_chat_completions_post",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.ChatCompletion, http_res)
