...
class Datasets(BaseSDK):
    ...
    def _init_sdks(self):
        self.entries = Entries(self.sdk_configuration, parent_ref=self.parent_ref)
    ...
    def create_entry(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.CreateDatasetEntryResponse, http_res)
    ...
    def get_entry(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetDatasetEntryResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
