...
class Embeddings(BaseSDK):
    def create(
        ...
        *,
        ...
        :param input: The input to embed, can be a single string or a list of strings
        :param model: The model to use for the embedding, if not provided, `EmbeddingModel(hosting_provider='Azure', location='EU', identifier='azure/text-embedding-3-large', name='azure/text-embedding-3-large-1536', dimensions=1536, max_tokens=8191, credentials='azure-se', is_default=True, is_public=True, extra={'api_base': 'https://opperopenaiservice.openai.azure.com', 'api_version': '2023-05-15', 'dimensions': 1536})` will be used
        ...
        http_res = self.do_request(
            ...
            request=req,
            error_status_codes=["400", "401", "404", "422", "4XX", "502", "5XX"],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(
                models.CreateEmbeddingResponse, http_res
            )
        ...
        if utils.match_response(http_res, "422", "application/json"):
            response_data = utils.unmarshal_json_response(errors.ErrorData, http_res)
