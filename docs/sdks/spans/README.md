...
with Opper(
    ...
    res = opper.spans.update(span_id="77b258a2-45c1-4b87-a50c-9116bc8ed1d6", name="my span", start_time=parse_datetime("2025-07-13T12:26:43.412686Z"), type="email_tool", end_time=parse_datetime("2025-07-13T12:26:43.412748Z"), input="Hello, world!", output="Hello, world!", error="Exception: This is an error message", meta={
        "key": "value",
    }, score=10)
